...
CREATE TABLE "SanctionEntry" (
    ...
    CONSTRAINT "SanctionEntry_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "SanctionChangeEvent" (
    ...
    CONSTRAINT "SanctionChangeEvent_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "SanctionSyncRun" (
    ...
    CONSTRAINT "SanctionSyncRun_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "SanctionChangeEvent" ADD CONSTRAINT "SanctionChangeEvent_entryId_fkey" FOREIGN KEY ("entryId") REFERENCES "SanctionEntry"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Invoice" ADD CONSTRAINT "Invoice_feeCalculationId_fkey" FOREIGN KEY ("feeCalculationId") REFERENCES "FeeCalculation"("id") ON DELETE SET NULL ON UPDATE CASCADE;
